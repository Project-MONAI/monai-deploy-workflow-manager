...
Scenario: Seed MinIO with patient metadata, and payload collection has details
    ...
    And I have a payload <metadata> and payload id <payloadId> in the bucket bucket1
    ...
    Examples:
    | workflowRequestMessage                     | metadata                 | patientTestData | payloadId                            |
    | Basic_AeTitle_Payload_Collection_Request_1 | full_patient_metadata    | Full_Patient    | 23b96697-0174-465c-b9cb-368b20a4591d |
    | Basic_Non_Existant_Request                 | partial_patient_metadata | Partial_Patient | c9c1e0f1-5994-4882-b3d4-9e1009729377 |
...
Scenario: Seed MinIO with blank patient data, and payload collection has null details
    ...
    And I have a bucket in MinIO bucket1
    And I have a payload null_patient_metadata and payload id 64a2b260-0379-4614-9f05-ff1279cf9e83 in the bucket bucket1
...
Scenario: Seed MinIO with no patient data, and payload collection has null details
    Given I have a clinical workflow Multi_Request_Workflow_Dispatched
    And I have a bucket in MinIO bucket1
    And I have a payload no_patient_metadata and payload id b91f5559-8ab2-455a-806d-961244ea22af in the bucket bucket1
