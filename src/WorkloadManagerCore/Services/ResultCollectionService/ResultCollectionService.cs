...
namespace Monai.Deploy.WorkloadManager.Core.Services.ResultCollectionService
{
    internal class ResultCollectionService : IHostedService, IDisposable, IMonaiService
    {
        private readonly ILogger<ResultCollectionService> _logger;
        public ServiceStatus Status { get; set; } = ServiceStatus.Unknown;

        public string ServiceName => "Data Export Collection Service";

        public ResultCollectionService(ILogger<ResultCollectionService> logger)
        {
