...
namespace Monai.Deploy.WorkloadManager.Test.Services.Http
{
    ...
    {
        private readonly Mock<ILogger<DataRetentionService>> logger;
        private readonly CancellationTokenSource cancellationTokenSource;

        public DataRetentionServiceTest()
        {
            this.logger = new Mock<ILogger<DataRetentionService>>();
        ...
        {
            var service = new DataRetentionService(this.logger.Object);
