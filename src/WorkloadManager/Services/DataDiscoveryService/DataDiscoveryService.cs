...
namespace Monai.Deploy.WorkloadManager.Services.DataDiscoveryService
{
    internal class DataDiscoveryService : IHostedService, IDisposable, IMonaiService
    {
        private readonly ILogger<DataDiscoveryService> logger;
        public ServiceStatus Status { get; set; } = ServiceStatus.Unknown;

        public string ServiceName => "Data Discovery Service";

        public DataDiscoveryService(ILogger<DataDiscoveryService> logger)
        {
