...
{
    internal class DataExportCollectionService : IHostedService, IDisposable, IMonaiService
    {
        private readonly ILogger<DataExportCollectionService> logger;
        public ServiceStatus Status { get; set; } = ServiceStatus.Unknown;

        public string ServiceName => "Data Export Collection Service";

        public DataExportCollectionService(ILogger<DataExportCollectionService> logger)
        {
