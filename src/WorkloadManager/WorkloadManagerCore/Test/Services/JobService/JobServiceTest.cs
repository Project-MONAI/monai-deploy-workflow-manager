...
namespace Monai.Deploy.WorkloadManager.Core.Test.Services.Http
{
    ...
    {
        private readonly Mock<ILogger<JobSchedulingService>> _logger;
        private readonly CancellationTokenSource _cancellationTokenSource;

        public JobServiceTest()
        {
            _logger = new Mock<ILogger<JobSchedulingService>>();
        ...
        {
            var service = new JobSchedulingService(_logger.Object);
