...
namespace Monai.Deploy.WorkloadManager.Services.ResultCollectionServiceTest
{
    ...
    {
        private readonly Mock<ILogger<ResultCollectionService>> _logger;
        private readonly CancellationTokenSource _cancellationTokenSource;

        public ResultCollectionServiceTest()
        {
            _logger = new Mock<ILogger<ResultCollectionService>>();
        ...
        {
            var service = new ResultCollectionService(_logger.Object);
